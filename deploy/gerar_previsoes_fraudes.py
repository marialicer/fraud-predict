...
def gerar_previsoes_modelo():
    ...
    clf = joblib.load("C:/Users/alice/OneDrive/Documentos/fraud-predict/deploy/modelo_treinado_fraude.pk")
    
    
    
    print("Gerando Previsões...")

    df_original = pd.read_csv("C:/Users/alice/OneDrive/Documentos/fraud-predict/predict/novos_dados.csv")
    ...
    df_original['PROBABILIDADES'] = probabilidades[:, 1]   # pegar só a probabilidade    

    df_original.to_excel("C:/Users/alice/OneDrive/Documentos/fraud-predict/predict/previsoes_fraude.xlsx")
